class AppConfig {
  ...
  static const String awsIoTEndpoint = 'your-iot-endpoint.iot.us-east-1.amazonaws.com';
  static const String kvsRegion = 'us-east-1';
  
  // Certificate paths (stored in assets/certificates/)
  static const String certificatePath = 'assets/certificates/certificate.pem.crt';
  ...
  static const String notificationChannelDescription = 'Notifications for doorphone events';
